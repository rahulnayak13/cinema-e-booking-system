...
export default function Home() {
  ...
  // Fetch from DB whenever search/filter/status changes
  useEffect(() => {
    let cancelled = false;
    setLoading(true);
    setErr("");
  ...
  // Genre options from currently fetched results (simple + demo-friendly)
      ...
      <div style={{ display: "flex", gap: 8, marginBottom: 16 }}>
        <button
          ...
          style={{
            ...
            background: statusTab === "CURRENTLY_RUNNING" ? "#eee" : "white",
          }}
        >
          Currently Running
        </button>
        <button
          ...
          style={{
            ...
            borderRadius: 10,
            border: "1px solid #ddd",
            background: statusTab === "COMING_SOON" ? "#eee" : "white",
          }}
        >
          Coming Soon
        </button>
